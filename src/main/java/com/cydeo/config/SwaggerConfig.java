...
@Configuration
@OpenAPIDefinition
public class SwaggerConfig { // I put one swagger configuration file, to make this create the swagger documentation for my application including OAuth2 Security structure
